...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hardware_models",
        type=str,
        default="./TransformerRoofline/hardware_models.json",
        help=(
            "Path to the TransformerRoofline hardware model catalogue. Defaults "
            "to the tracked file; point it at a copy to add or edit hardware "
            "entries without mutating the tracked one."
        ),
    )
